            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
              <div class="col-sm-12">
                <h4 class="page-title">Formulaire DCA</h4>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="p-20">
                        ...
                        <input type="text" placeholder="" name="specialite" class="form-control">
                      </div>
                        
                        
                          <div class="form-group m-b-0">
                            <input type="hidden" name="type" placeholder=""  value="dca" class="form-control">
