            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
              <div class="col-sm-12">
                <h4 class="page-title">Formulaire DCESS</h4>
              ...
              <div class="col-sm-12">
                <div class="card-box">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="p-20">
                        <form action="formation-add.php" method="post">
                        ...
                        <input type="text"  name="specialite" class="form-control">
                          ...
                          <div class="form-group m-b-0">
                            <input type="hidden" name="type" placeholder=""  value="dcess" class="form-control">
                     ...
                     <div class="col-md-6">
                      <div class="p-20">
                       ...
                       <div class="form-group">
                            ...
                            <select class="selectpicker" data-style="btn-primary btn-custom" name="responsable">
                               <?php 
                            $req2=$bdd->query('SELECT * FROM professeur ');
                            while($data2=$req2->fetch()) { ?>
                              <option value="<?= $data2['CIN'];?>"><?= $data2['NOM'];?> <?= $data2['PRENOM']?></option>
                              <?php } 
                                $req2->closeCursor(); ?>
                              </select>
                          </div>
                          <div class="form-group">
                            <label>PreRequis*</label>
                              <input type="text" name="prerequis" placeholder="" class="form-control">
                              
                          </div>
                     
                          <div class="form-group m-b-0">
                            <label>Lien Web </label>
                            <input type="text" placeholder="" name="lien" class="form-control">
                            
                          </div>
                    
                          <div class="form-group text-right m-b-0">
                          <br>
                      <button class="btn btn-primary waves-effect waves-light" name="env" type="submit">
                        Enregistrer 
                      </button>
