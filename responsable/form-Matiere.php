                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="p-20">
                          ...
                          <div class="form-group">
                            ...
                            <input required="required" type="text" placeholder=""  name="nbh" class="form-control">
                            
                          </div>
                         <div class="form-group">
                            <label>Cout*</label>
                            <input required="required" type="text" placeholder=""  name="cout" class="form-control">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="form-group">
                            ...
                            <select class="selectpicker" data-style="btn-primary btn-custom" name="module">
                               <?php 
                               $req1=$bdd->prepare('SELECT * from formation where RESPONSABLE=?');
                                $req1->execute(array($_SESSION['cin']));
                                $data777=$req1->fetch();
                                $req1->closeCursor();
                            $req2=$bdd->prepare('SELECT * FROM module,form_module where module.NUM_MODULE=form_module.NUM_MODULE and TYPE=? and SPECIALITE=? and DATE_DEBUT=? ');
                            $req2->execute(array($data777['TYPE'], $data777['SPECIALITE'],$data777['DATE_DEBUT']));
                            while($data2=$req2->fetch()) { ?>
                              <option value="<?= $data2['NUM_MODULE'] ?>"><?= $data2['NOM_MODULE'];?></option>
                              <?php } 
                                $req2->closeCursor(); ?>
                              </select>
...
{    
  ...
  $operation=' a ajoute une nouvelle matière :  '.$_POST['nom'];
  ...
  $req2->closeCursor();
  //
  $req=$bdd->prepare('INSERT INTO matiere(NOM_MATIERE,NB_HEURE,NUM_MODULE,COUT) VALUES(?,?,?,?)');
