...
<html>
 ...
 ?> 
      ...
      <!-- ============================================================== -->
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
              <div class="col-sm-12">
                <h4 class="page-title">Formulaire</h4>
                <!--<ol class="breadcrumb">
                  <li>
                    <a href="#">Ubold</a>
                  </li>
            ...
            <?php 
            $req5=$bdd->prepare('SELECT * FROM formation where RESPONSABLE=?');
                  $req5->execute(array($cin));
                  $data5=$req5->fetch();
                  $req5->closeCursor();?>
                        <div class="row">
              <div class="col-sm-12">
                <div class="card-box">
                  ...
                  <div class="row">
                    <form action="etudiant-add.php" method="post"  enctype="multipart/form-data">
                    <div class="col-md-6">
                      <div class="p-20">
                        
                          <div class="form-group">
                            <label>Nom*</label>
                            <input required="required" type="text" placeholder="" name="nom" class="form-control">
                            
                          </div>
                          <div class="form-group">
                            <label>Prenom*</label>
                            <input required="required" type="text" placeholder=""  name="prenom" class="form-control">
                            
                          </div>
                          <div class="form-group">
                            <label>CNE</label>
                            <input  type="text" placeholder=""  name="cne" class="form-control">
                            
                          </div>
                          <div class="form-group">
                            <label>Cin*</label>
                              <input required="required" type="text" placeholder="" name="cin" class="form-control">
                              
                          </div>
                     
                          <div class="form-group m-b-0">
                            <label>Ville de naissance </label>
                            <input  type="text" placeholder=""  name="ville" class="form-control">
                            
                          </div>
                          <div class="form-group m-b-0">
                            <label>Date de naissance </label>
                            <input  type="date" placeholder=""   name="naissance" class="form-control">
                      ...
                      <div class="form-group m-b-0">
                          ...
                          <br/>
                            ...
                            <input  type="text"  name="bactype" placeholder="Sc.Math"  class="form-control">
                      ...
                      <div class="p-20">
                        <!--<form action="#"> -->
                           ...
                           <div class="form-group m-b-0">
                            ...
                            <input  name="datebac" type="txt" placeholder=""  class="form-control">
                           ...
                           <div class="form-group m-b-0">
                            ...
                            <input  type="text" name="datediplome" placeholder="2012-2013"  class="form-control">
                          </div>
                          <br/>
                        
                          
                            
                           <input  type="hidden" name="type" value="<?= $data5['TYPE']?>" placeholder="2012-2013"  class="form-control">
                            
                           
                            <input  type="hidden" name="datedebut"value="<?= $data5['DATE_DEBUT']?>" placeholder="2012-2013"  class="form-control">
                          
                            
                           
                            <input  type="hidden" placeholder="" value="<?= $data5['SPECIALITE']?>" name="specialite" class="form-control">
                            
                         
                          
                          <div class="form-group m-b-0">
                            <label>Tel </label>
                            <input  type="text" placeholder="" name="tel" data-mask="99-99999999" class="form-control">
                            
                          </div>
                          <div class="form-group m-b-0">
                            <label>Email* </label>
                            <input required="required" type="text" placeholder="" name="email" class="form-control" id="inputEmail3">
                            
                          </div>
                           <div class="form-group m-b-0">
                            <label> Adresse </label>
                            <input  name="adresse" type="txt" placeholder=""  class="form-control">
                        ...
                        <br/>
                          <div class="form-group m-b-0">
                            ...
                            <input required="required" type="text" value=""   name="montant" data-mask="99-99999999" class="form-control">
