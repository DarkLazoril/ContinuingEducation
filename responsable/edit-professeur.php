 ...
 ?> 
      ...
      <!-- ============================================================== -->
            ...
            <!-- ============================================================== -->                      
               <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
              <div class="col-sm-12">
                <h4 class="page-title">Modification: </h4><br/>
                <!--<ol class="breadcrumb">
                  <li>
                    <a href="#">Ensat</a>
                  </li>
              ...
              <?php $req3=$bdd->prepare('SELECT * FROM professeur WHERE CIN=? ');
              ...
              <div class="col-sm-12">
                <div class="card-box">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="p-20">
                        <form action="professeur-update.php" method="post" enctype="multipart/form-data" >
                          <div class="form-group">
                            <label>Nom*</label>
                            <input required="required" name="Nom" type="text"  value="<?= $data3['NOM'] ?>"  class="form-control">
                            
                          </div>
                          <div class="form-group">
                            <label>Prenom*</label>
                            <input required="required" name="Prenom" type="text" value="<?= $data3['PRENOM'] ?>"  class="form-control">
                          ...
                          <div class="form-group">
                            <label>Cin*</label>
                              <input required="required" name="Cin" type="text" value="<?= $data3['CIN'] ?>"  class="form-control">
                          ...
                          <div class="form-group m-b-0">
                            ...
                            <input  name="ddn" type="date" value="<?= $data3['DATE_N'] ?>"   class="form-control">
                          ...
                          <br/>
                            ...
                            <select class="selectpicker" name="sexe" data-style="btn-primary btn-custom" name="module">
                       ...
                       <div class="form-group m-b-0">
                            ...
                            <input  name="dept" type="text"  nom="typeBac" value="<?= $data3['DEPART'] ?>"   class="form-control">
             ...
             <div class="form-group m-b-0">
                            <label>Salaire </label>
                            <input  name="salaire" type="text"  nom="typeBac" value="<?= $data3['SALAIRE'] ?>"   class="form-control">
                            
                          </div>
              <br/>
                           <div class="form-group m-b-0">
                            <label>Lien blog </label>
                            <input  name="lb" type="text" nom="dateBac" value="<?= $data3['LIEN_BLOG'] ?>"   class="form-control">
                          ...
                          <div class="form-group m-b-0">
                            ...
                            <input  name="biog" type="textarea" value="<?= $data3['BIOGRAPHIE'] ?>"  nom="dateBac"   class="form-control">
                          ...
                          <div class="form-group m-b-0">
                            <label>Tel </label>
                            <input  name="Tel" type="text" value="<?= $data3['TEL'] ?>"  data-mask="99-99-9999" class="form-control">
                            
                          </div>
                          <div class="form-group m-b-0">
                            <label>Email* </label>
                            <input required="required" name="Email" type="text" value="<?= $data3['EMAIL'] ?>"  class="form-control" id="inputEmail3">
                            
                          </div>
                           <div class="form-group m-b-0">
                            <label> Adresse </label>
                            <input  name="adrs" type="txt" value="<?= $data3['ADRESSE'] ?>"   class="form-control">
