                ...
                <div class="content">
                    <div class="container">
                            ...
                            <div class="col-sm-12">
                             ...
                             <div class="p-20">
                              ...
                              <tr>
                                  ...
                                  <form method="POST" action=" ImportEtudiant.php" enctype="multipart/form-data">
                                  <td>
                              ...
                              <td> </td> <td>
                                <a href="../uploads_photo/ListeEtudiantsExemple" download="../uploads_photo/ListeEtudiantsExemple" ><button  name="send" class="btn btn-default btn-md waves-effect waves-light">Exemple</button></a>
                                
                              </td><td>

                                <form method="POST" action="ExportEtudiant.php">
                                <button type="submit" name="send" class="btn btn-default btn-md waves-effect waves-light">Export</button>
                               </form>
                             </td>
                              <td> </td>
                              <td>
                                 <form method="POST" action="archiveEtudiant.php">
                                <button type="submit" name="send" class="btn btn-default btn-md waves-effect waves-light">Archive</button>
                               </form>
                             </td>
                        ...
                        <tr>
                          ...
                          <th>Nom</th>
                          <th align="center">type paiement</th>
                          <th>Echeances</th>
                          <th>Detail</th>
                          <th>Action</th>
                                                     ...
                                                     <?php 
                                                        $req4=$bdd->prepare('SELECT COUNT(NUM) AS nb FROM echeance WHERE cin=?');
                                                        $req4->execute(array($data2['CIN']));
                                                        $data4=$req4->fetch();
                                                        $nb_echeance_paye=$data4['nb'];
                                                        $req4->closeCursor();
                                                        ?>
                                            ...
                                            <tbody>
                                             <?php // recupeartin du form
                                               ...
                                               $req2=$bdd->prepare('SELECT * FROM etudiant WHERE DATE_DEBUT_FOR=? AND TYPE_FOR=? AND SPECIALITE_FOR=? order by NOM');
                                                ...
                                                <tr class="active">
                                                    ...
                                                    <td>
                                                       ...
                                                       <?php 
                                                        ...
                                                        $req4->closeCursor();
                                                        ?>
                                                    <form method="post" action="echeance.php">
                                                    <td> 
                                                      
                                                       <div class="checkbox checkbox-primary m-r-15">
                                                            <input name="checkbox1" checked="checked" value="espece"  type="checkbox">
                                                             <label for="checkbox3" >espece</label>
                                                             </div>
                                                             <div class="checkbox checkbox-primary m-r-15">
                                                            <input name="checkbox1" checked="checked" type="checkbox" value="cheque">
                                                             <label for="checkbox3">cheque</label>
                                                             </div>
                                                             <div class="checkbox   checkbox-primary m-r-15">
                                                            <input name="checkbox1" checked="checked" type="checkbox" value="p-e-c" >
                                                            <label for="checkbox3" > prise en charge</label>
                                                           </div>
                                                       <input type="hidden" name="cin" value="<?= $data2['CIN'] ?>" >
                                                       <input type="hidden" name="nom" value="<?= $data2['NOM'] ?>" >
                                                       <input type="hidden" name="type" value="<?= $data50['TYPE'] ?>" >
                                                       <input type="hidden" name="prenom" value="<?= $data2['PRENOM'] ?>" >
                                                       <input type="hidden" name="nb_echeance_paye" value="<?= $nb_echeance_paye ?>" >
                                                    ...
                                                    <?php
                                                  if($data50['TYPE']=="dcess")
                                                  {
                                                    if(3-$nb_echeance_paye==0 || $data2['montant_rest']==0)
                                                            {
                                                              echo 'Payer';
                                                            }
                                                    else{
         
                                                        for($i=0;$i<3-$nb_echeance_paye;$i++)
                                                          {?>
                                                         ...
                                                         if(2-$nb_echeance_paye==0 || $data2['montant_rest']==0)
                                                            {
                                                              echo 'Payer';
                                                            }
                                                    else{
         
                                                        for($i=0;$i<2-$nb_echeance_paye;$i++)
                                                          {?>
                                                    ...
                                                    <td>
                                                         <a href="detail-etudiant.php?cin=<?php echo $data2['CIN'] ?>&amp;montant_glob=<?= $data2['montant_for']?>&amp;rest=<?= $data2['montant_rest']?>" class="table-action-btn">+</a>   
                                                    </td>
                                                    <td>
                                                      <a href="edit-etudiant.php?cin=<?php echo $data2['CIN'] ?>" class="table-action-btn"><i class="md md-edit"></i></a>
                                                      <a href="etudiant-delete.php?cin=<?php echo $data2['CIN'] ?>&amp;nom=<?php echo $data2['NOM'] ?>&amp;prenom=<?php echo $data2['PRENOM'] ?>" class="table-action-btn"><i class="md md-close"></i></a>
                                                    </td>
