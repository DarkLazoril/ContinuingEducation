 ...
 ?> 
      ...
      <!-- ============================================================== -->
            ...
            <!-- ============================================================== -->                      
              ...
              <div class="col-sm-12">
                <div class="card-box">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="p-20">
                        <form action="form-Prof.php" method="post" enctype="multipart/form-data" >
                       ...
                       <div class="form-group m-b-0">
                            ...
                            <input  name="dept" type="text"  nom="typeBac" placeholder=""  class="form-control">
             ...
             <div class="form-group m-b-0">
                            <label>Salaire </label>
                            <input  name="salaire" type="text"  nom="typeBac" placeholder=""  class="form-control">
                            
                          </div>
              <br/>
                           <div class="form-group m-b-0">
                            <label>Lien blog </label>
                            <input  name="lb" type="text" nom="dateBac" placeholder=""  class="form-control">
                          ...
                          <div class="form-group m-b-0">
                            ...
                            <input  name="biog" type="textarea" nom="dateBac"   class="form-control">
